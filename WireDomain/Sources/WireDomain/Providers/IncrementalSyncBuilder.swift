...
public final class UserComponent {
    ...
    public func makeActiveSessionComponent(selfClientID: String) -> ActiveSessionComponent {
...
public final class ActiveSessionComponent {
    ...
    private lazy var pushChannelAPI: any PushChannelAPI = {
        PushChannelAPIBuilder(pushChannelService: pushChannelService).makeAPI()
    }()
