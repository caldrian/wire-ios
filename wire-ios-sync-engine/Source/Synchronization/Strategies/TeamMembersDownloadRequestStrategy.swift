...
// SOLUTION
// - Rely on team ID
// - Mark as needing to download membership.
// - If discover that a member is on team but no membership then we should download their membership (OPTIONAL)
//   - We could create this membership locally and mark as needing to update from backend

// TODO:
// - Check search works when we know haven't downloaded membership
// - Resync resources when self becomes part of a team?
// - `isTeamMember` remove / change (low priority)
